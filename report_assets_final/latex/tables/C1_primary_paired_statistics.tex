...
\centering
\small
\caption{Primary paired statistics on the canonical test set (paired class-stratified bootstrap, seed 42, 10,000 replicates, N = 1,331). C vs B is from Task 7; E vs B and G vs E are the 10,000-replicate Task 8B closure.}
\label{tab:primarypaired}
\begin{tabular}{p{5.0cm}lrrrl}
\toprule
