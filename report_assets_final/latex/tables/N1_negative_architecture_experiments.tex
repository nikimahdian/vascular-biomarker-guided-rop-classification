...
\centering
\small
\caption{Secondary exploratory neural experiments that did not improve on the frozen concatenation models. Values are canonical test-set metrics; none of these models is a primary result.}
\label{tab:negative}
\begin{tabular}{p{4.6cm}rrrrrp{5.4cm}}
\toprule
